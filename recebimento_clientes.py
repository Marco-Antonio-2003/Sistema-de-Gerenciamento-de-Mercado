...
class RecebimentoClientes(QWidget):
    ...
    def alterar(self):
        ...
        try:
            ...
            import formulario_recebimento_clientes
            ...
            formulario_widget = formulario_recebimento_clientes.FormularioRecebimentoClientes(janela_parent=self.janela_formulario)
...
if __name__ == "__main__":
    ...
    recebimento_widget = RecebimentoClientes(window)  # Passa a janela como parent
