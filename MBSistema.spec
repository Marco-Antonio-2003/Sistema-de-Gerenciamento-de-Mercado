...
a = Analysis(
    ...
    pathex=[],
    binaries=[],
    datas=[('ico-img', 'ico-img'), ('PDV', 'PDV'), ('geral', 'geral'), ('vendas', 'vendas'), ('produtos_e_servicos', 'produtos_e_servicos'), ('compras', 'compras'), ('financeiro', 'financeiro'), ('relatorios', 'relatorios'), ('ferramentas', 'ferramentas'), ('mercado_livre', 'mercado_livre'), ('cupons', 'cupons'), ('syncthing.exe', '.'), ('assistente_historico.json', '.'), ('config.json', '.'), ('config/favorites.json', 'config')],
