...
class NFCEWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Manutenção de Notas Fiscais - NFC-e")
    ...
    def initUI(self):
        ...
        # Adicionar linhas de exemplo para NFC-e
        ...
        self.table.setItem(0, 2, QTableWidgetItem("0000098"))
        self.table.setItem(0, 3, QTableWidgetItem("01/04/25"))
        self.table.setItem(0, 4, QTableWidgetItem("0000414"))
        self.table.setItem(0, 5, QTableWidgetItem("AUTOPEÇAS XYZ LTDA"))
        self.table.setItem(0, 6, QTableWidgetItem("325,75"))
        ...
        self.table.setItem(1, 2, QTableWidgetItem("0000099"))
        self.table.setItem(1, 3, QTableWidgetItem("01/04/25"))
        self.table.setItem(1, 4, QTableWidgetItem("0000415"))
        self.table.setItem(1, 5, QTableWidgetItem("PADARIA PÃO QUENTE LTDA"))
        self.table.setItem(1, 6, QTableWidgetItem("117,80"))
        self.table.setItem(1, 7, QTableWidgetItem(""))
        
        # Terceira linha
        check3 = QTableWidgetItem()
        check3.setFlags(Qt.ItemIsUserCheckable | Qt.ItemIsEnabled)
        check3.setCheckState(Qt.Unchecked)
        self.table.setItem(2, 0, check3)
        
        email3 = QTableWidgetItem()
        email3.setFlags(Qt.ItemIsUserCheckable | Qt.ItemIsEnabled)
        email3.setCheckState(Qt.Unchecked)
        self.table.setItem(2, 1, email3)
        
        self.table.setItem(2, 2, QTableWidgetItem("0000100"))
        self.table.setItem(2, 3, QTableWidgetItem("01/04/25"))
        self.table.setItem(2, 4, QTableWidgetItem("0000416"))
        self.table.setItem(2, 5, QTableWidgetItem("JOSE MARIA DA SILVA"))
        self.table.setItem(2, 6, QTableWidgetItem("42,90"))
        ...
        self.tabs.addTab(info_tab, "Informações NFC-e")
    ...
    def abrir_detalhe_nota(self, row, column):
        ...
        try:
            ...
            detalhes_window = DetalheNotaFiscalWindow(self, "NFC-e", nota_id)
    ...
    def incluir(self):
        print("Incluindo nota fiscal...")
        # Implementar lógica para incluir nota
