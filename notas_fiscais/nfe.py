...
class NFEWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        self.table.setItem(0, 2, QTableWidgetItem("0000094"))
        self.table.setItem(0, 3, QTableWidgetItem("01/04/25"))
        self.table.setItem(0, 4, QTableWidgetItem("0000410"))
        self.table.setItem(0, 5, QTableWidgetItem("SIND DOS EMPREGADOS RURAIS DE RIB BRANCO E"))
        self.table.setItem(0, 6, QTableWidgetItem("660,00"))
        ...
        self.table.setItem(1, 2, QTableWidgetItem("0000095"))
        self.table.setItem(1, 3, QTableWidgetItem("01/04/25"))
        self.table.setItem(1, 4, QTableWidgetItem("0000411"))
        self.table.setItem(1, 5, QTableWidgetItem("JULIO CESAR DE MAGALHAES"))
        self.table.setItem(1, 6, QTableWidgetItem("90,00"))
        ...
        self.tabs.addTab(info_tab, "Informações N.F.E.")
    ...
    def abrir_detalhe_nota(self, row, column):
        ...
        try:
            ...
            detalhes_window = DetalheNotaFiscalWindow(self, "NFE", nota_id)
